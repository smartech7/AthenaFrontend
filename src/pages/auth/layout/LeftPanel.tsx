  ...
  return (
    <div className="relative flex flex-col h-full pb-5 overflow-hidden bg-black">
      ...
      <div className="flex flex-col items-center flex-1 w-full h-full gap-4 px-10">
        ...
        <div className="container text-center 2xl:px-36 xl:px-28 lg:px-16">
          <h2 className="text-white text-[34px] font-semibold">
        ...
        <div className="flex items-center justify-center gap-4 mt-7">
          <img src="/images/app_store.svg" width={200} height={64} />
          <img src="/images/google_play.svg" width={200} height={64} />
        </div>
      </div>
    </div>
  );
